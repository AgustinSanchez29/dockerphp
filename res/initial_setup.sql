...
create table acc_transaction ( txn_id bigint not null auto_increment,
...
create table branch ( branch_id integer not null auto_increment,
address varchar(30),
city varchar(20),
...
create table business ( incorp_date date,
name varchar(255) not null,
state_id varchar(10) not null,
cust_id integer not null,
primary key (cust_id) );

create table customer ( cust_id integer not null auto_increment,
address varchar(30),
city varchar(20),
...
create table department ( dept_id integer not null auto_increment,
name varchar(20) not null,
primary key (dept_id) );
...
create table individual ( birth_date date,
first_name varchar(30) not null,
last_name varchar(30) not null,
cust_id integer not null,
primary key (cust_id) );

create table officer ( officer_id integer not null auto_increment,
end_date date,
first_name varchar(30) not null,
last_name varchar(30) not null,
start_date date not null,
...
create table product ( product_cd varchar(10) not null,
date_offered date,
date_retired date,
...
create table product_type ( product_type_cd varchar(255) not null,
name varchar(50),
primary key (product_type_cd) );

alter table account add constraint account_customer_fk foreign key (cust_id) references customer (cust_id);

alter table account add constraint account_branch_fk foreign key (open_branch_id) references branch (branch_id);

alter table account add constraint account_employee_fk foreign key (open_emp_id) references employee (emp_id);

alter table account add constraint account_product_fk foreign key (product_cd) references product (product_cd);

alter table acc_transaction add constraint acc_transaction_account_fk foreign key (account_id) references account (account_id);

alter table acc_transaction add constraint acc_transaction_branch_fk foreign key (execution_branch_id) references branch (branch_id);

alter table acc_transaction add constraint acc_transaction_employee_fk foreign key (teller_emp_id) references employee (emp_id);

alter table business add constraint business_employee_fk foreign key (cust_id) references customer (cust_id);

alter table employee add constraint employee_branch_fk foreign key (assigned_branch_id) references branch (branch_id);
...
alter table individual add constraint individual_customer_fk foreign key (cust_id) references customer (cust_id);

alter table officer add constraint officer_customer_fk foreign key (cust_id) references customer (cust_id);

alter table product add constraint product_product_type_fk foreign key (product_type_cd) references product_type (product_type_cd);
...
where
	((last_name = 'gooding'
	and first_name = 'john')
	or (last_name = 'fleming'
	and first_name = 'helen')
	or (last_name = 'roberts'
	and first_name = 'paula')
	or (last_name = 'blake'
	and first_name = 'john')
	or (last_name = 'markham'
	and first_name = 'theresa'));
